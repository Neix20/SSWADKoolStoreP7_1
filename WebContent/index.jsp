...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					...
					<%
						out.println("<div class=\"product-item-1\" onclick=\"location.href='Product?productCode="
								+ productlist.get(0).getProductcode() + "';\" style=\"cursor: pointer;\">");
					%>
					...
					<div class="product-content">
						<%
							out.println("<h5><a href = \"Product?productCode=" + productlist.get(0).getProductcode() + "\">"
									+ productlist.get(0).getProductname() + "</a></h5>");
			...
			<div class="col-md-5">
				<div class="product-holder">
					...
					<%
						out.println("<div class=\"product-item-2\" onclick=\"location.href='Product?productCode="
								+ productlist.get(1).getProductcode() + "';\" style=\"cursor: pointer;\">");
					%>
					...
					<div class="product-content overlay">
						...
						<%
							out.println("<h5><a href = \"Product?productCode=" + productlist.get(1).getProductcode() + "\">"
									+ productlist.get(1).getProductname() + "</a></h5>");
				...
				<%
					out.println("<div class=\"product-item-2\" onclick=\"location.href='Product?productCode="
							+ productlist.get(2).getProductcode() + "';\" style=\"cursor: pointer;\">");
				%>
				<div class="product-thumb">
					<%
				...
				<div class="product-content overlay">
					<%
						out.println("<h5><a href = \"Product?productCode=" + productlist.get(2).getProductcode() + "\">"
								+ productlist.get(2).getProductname() + "</a></h5>");
	...
	<div class="col-md-4">
		...
		<%
			out.println("<div class=\"product-item-3\" onclick=\"location.href='Product?productCode="
					+ productlist.get(3).getProductcode() + "';\" style=\"cursor: pointer;\">");
		%>
		<div class="product-thumb">
			<%
		...
		<div class="product-content">
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<%
						out.println("<h5><a href = \"Product?productCode=" + productlist.get(3).getProductcode() + "\">"
								+ productlist.get(3).getProductname() + "</a></h5>");
	...
	<div class="row">
		<div class="col-md-4 col-sm-6 col-xs-12">
			...
			<%
				out.println("<div class=\"product-item-4\" onclick=\"location.href='Product?productCode="
						+ productlist.get(4).getProductcode() + "';\" style=\"cursor: pointer;\">");
			%>
			<div class="product-thumb">
				<%
			...
			<div class="product-content overlay">
				<%
					out.println("<h5><a href = \"Product?productCode=" + productlist.get(4).getProductcode() + "\">"
							+ productlist.get(4).getProductname() + "</a></h5>");
	...
	<div class="col-md-4 col-sm-6 col-xs-12">
		...
		<%
			out.println("<div class=\"product-item-4\" onclick=\"location.href='Product?productCode="
					+ productlist.get(5).getProductcode() + "';\" style=\"cursor: pointer;\">");
		%>
		<div class="product-thumb">
			<%
		...
		<div class="product-content overlay">
			<%
				out.println("<h5><a href = \"Product?productCode=" + productlist.get(5).getProductcode() + "\">"
						+ productlist.get(5).getProductname() + "</a></h5>");
			...
			<div class="row">
				<%
					...
					for (count = 6; count < 10; count++) {
						...
						out.println("<div class=\"product-item\" onclick=\"location.href='Product?productCode="
								+ productlist.get(count).getProductcode() + "';\" style=\"cursor: pointer;\">");
						...
						out.println("<h5><a href = \"Product?productCode=" + productlist.get(count).getProductcode() + "\">"
								+ productlist.get(count).getProductname() + "</a></h5>");
